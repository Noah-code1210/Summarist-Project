  ...
  return (
    <section>
      <div className="relative flex flex-col ml-[200px] w-[1669px] transition-all">
        <div className="bg-white border-b-1 border-solid border-b-[#e1e7ea] h-20 z-1">
          <div className="relative flex items-center justify-between px-8 max-w-[1920px] mx-auto h-full">
            <figure>
              <img src="" alt="" />
            </figure>
              ...
              <div className="flex items-center w-full">
                <div className="relative gap-2">
                  <input
                    ...
                    className="w-full h-10 px-4 outline-none bg-[#f1f6f4] text-[#042330] border-solid border-2 border-[#e1e7ea] rounded-lg"
                  />
