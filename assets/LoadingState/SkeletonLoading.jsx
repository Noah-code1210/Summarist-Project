    ...
    <>
      <div className="w-full max-w-[1070px] mx-auto px-6">
        <div className="w-full py-10">
          ...
          <div className="flex flex-wrap gap-x-10 snap-x snap-mandatory mb-12">
            {Array(8)
              .fill(null)
              .map((_, index) => (
                <div
                  className="relative h-80 flex flex-wrap gap-x-4 snap-x snap-mandatory mb-8"
                  key={index}
                >
          ...
          <div className="account__section--title">Suggested Books</div>
          <div className="font-light color-[#394547] mb-4">
            Browse those books
          </div>
          <div className="flex flex-wrap gap-x-10 snap-x snap-mandatory mb-12">
